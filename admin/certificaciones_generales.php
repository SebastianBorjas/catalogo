...
<html lang="es">
    ...
    <script src="peticion_certificaciones.js"></script>
<!----------------------------------------------------------------------------------------->
   ...
   <!--<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>-->
	...
	<body>
		<header>
			...
			<h2>BASE DE DATOS DE CERTIFICACIONES REGISTRADAS</h2>
			</div>
		</header>
				...
				swal({
					...
					preConfirm: function() {
					  return new Promise(function(resolve) {
						 ...
						 $.ajax({
							   url: 'Formato_certificaciones.php',
							type: 'POST',
							   data: {'id':id},
							   dataType: 'json'
						 })
						 .done(function(response){
							 ...
							 window.open('ArchivosSocios/CATÁLOGO_CAPACIDADES_CERTIFICACIONES.pdf');
							 location.reload();
						 })
