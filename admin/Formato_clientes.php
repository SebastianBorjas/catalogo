...
$query2 = "SELECT * FROM Cliente WHERE idEmpresa = $id";
$resultado2 = mysqli_query($db,$query2); 

$query3 = "SELECT COUNT(*) FROM Cliente WHERE idEmpresa = $id";
...
/*class pdf2 extends FPDF{ 
        ...
        $pdf->SetTextColor(0,0,0,255);
        $pdf->SetXY(100, 53);
        $pdf->MultiCell(40, 5,utf8_decode('TELÉFONO / PHONE'), 1, 'J', false);
        //CUADRO DE TEXTO
        $pdf->SetXY(140, 53);
...
$pdf->Output('ArchivosSocios/CATÁLOGO_CAPACIDADES_CLIENTES.pdf','F');
