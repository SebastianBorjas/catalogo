...
<html lang="es">
    ...
    <script src="peticion_clientes.js"></script>
<!----------------------------------------------------------------------------------------->
   ...
   <!--<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>-->
	...
	<body>
		<header>
			...
			<h2>BASE DE DATOS DE CLIENTES REGISTRADOS</h2>
			</div>
		</header>
					...
					preConfirm: function() {
					  return new Promise(function(resolve) {
						 ...
						 .done(function(response){
							 ...
							 window.open('ArchivosSocios/CATÁLOGO_CAPACIDADES_CLIENTES.pdf');
							 location.reload();
						 })
