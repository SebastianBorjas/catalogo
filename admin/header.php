...
<nav id="nvartop" class="navbar navbar-expand-sm bg-dark navbar-dark" style="margin-left: 230px; background-color: #00324b!important; border-radius: 0px;">
  <!-- Brand/logo 
 ...
 <!-- <ul class="navbar-nav">
    ...
    <label>CANACINTRA MONCLOVA</label>
    </div>
