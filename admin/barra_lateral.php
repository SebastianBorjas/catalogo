...
<!--	<a href="#" class="boton-cerrar" onclick="ocultar()">X</a>-->
  <a class="navbar-brand" href="company_profile.php" style="margin-left: 25px; margin-right: 25px;">
    <img src="imagenes/LOGO-CANACINTRA DELEGACIÓN MONCLOVA BLANCO.png" alt="logo" style="width:150px;">
      ...
      <ul>
        <li class='sub-menu'><a href='#settings'>Clasificaciones  <div class='fa fa-caret-down right'></div></a><br>
          <ul>
		  	<li><a href='busqueda.php'>General-Empresas</a></li>
            <li><a href='productos_generales.php'>Productos</a></li>
            <li><a href='procesos_generales.php'>Procesos</a></li>
            <li><a href='clientes_generales.php'>Clientes</a></li>
            <li><a href='certificaciones_generales.php'>Certificaciones</a></li>
          </ul>
        </li>       
