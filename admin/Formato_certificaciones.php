...
$query2 = "SELECT * FROM Certificacion WHERE idEmpresa = $id";
$resultado2 = mysqli_query($db,$query2); 

$query3 = "SELECT COUNT(*) FROM Certificacion WHERE idEmpresa = $id";
...
$pdf->Output('ArchivosSocios/CATÁLOGO_CAPACIDADES_CERTIFICACIONES.pdf','F');
