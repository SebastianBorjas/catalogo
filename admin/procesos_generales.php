...
<html lang="es">
    ...
    <script src="peticion_procesos.js"></script>
<!----------------------------------------------------------------------------------------->
   ...
   <!--<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>-->
	...
	<body>
		<header>
			...
			<h2>BASE DE DATOS DE PROCESOS REGISTRADOS</h2>
			</div>
		</header>
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '#ValidarFormato', function(e){
					
					var id2= $(this).data('id');
					SwalConfirmacion2(id2);
					e.preventDefault();
				});
		...
		<!-- función generar pdf corto-->
		<script>
				function SwalConfirmacion(id){
				
				swal({
					title: '¿Generar documento pdf reducido?',
					...
					preConfirm: function() {
					  return new Promise(function(resolve) {
						 ...
						 .done(function(response){
							 ...
							 window.open('ArchivosSocios/CATÁLOGO_CAPACIDADES_PROCESOS.pdf');
							 location.reload();
						 })
		...
		<script>
				...
				function SwalConfirmacion2(id2){
				
				swal({
					title: '¿Generar documento pdf detallado?',
					text: "Se generará el archivo PDF del registro seleccionado",
					type: 'info',
					showCancelButton: true,
					confirmButtonColor: '#3085d6',
