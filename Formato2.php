<?php
    ...
    try{
        $pdo = new PDO('mysql:host=canacintramonclova.com;dbname=dbpqeyuwx1ejlw', 'canacin8_proye20', 'CDOufbu0fa!A');
...
$posicion_MulticeldaIPNY =101;   //91
$posicion_MulticeldaIPRTX =45;
$posicion_MulticeldaIPRTY =101;  //91
$posicion_MulticeldaIPCX =45;
$posicion_MulticeldaIPCY =101;   //91

//Descripción
$posicion_MulticeldaIDX =10;
$posicion_MulticeldaIDY =107;    //97   //Cuadro que encapsula el primer texto
$posicion_MulticeldaIDTX =45;
$posicion_MulticeldaIDTY =107;   //97   //Texto del segundo cuadro
$posicion_MulticeldaIDCX =45;
$posicion_MulticeldaIDCY =107;   //97   //cuadro que encapsula el segundo texto

//Cantidad equipo
$posicion_MulticeldaICEX =10;
$posicion_MulticeldaICEY =113; //103    //Cuadro que encapsula el primer texto
$posicion_MulticeldaICETX =45;
$posicion_MulticeldaICETY =113; //103   //Texto del segundo cuadro
$posicion_MulticeldaICECX =45;
$posicion_MulticeldaICECY =113; //103   //cuadro que encapsula el segundo texto

//Capacidad Kg
$posicion_MulticeldaICX =10;
$posicion_MulticeldaICY =119; //109     //Cuadro que encapsula el primer texto
$posicion_MulticeldaICTX =45;
$posicion_MulticeldaICTY =119; //109    //Texto del segundo cuadro
$posicion_MulticeldaICCX =45;
$posicion_MulticeldaICCY =119; //109    //cuadro que encapsula el segundo texto
    ...
    while($row = $resultado->fetch(PDO::FETCH_ASSOC)){
        ...
        while($fila = $resultado4->fetch(PDO::FETCH_ASSOC))
             ...
             if($posicion_MulticeldaIIX >= '200' )
            {
                //Cuadro que encapsula imagen
                $posicion_MulticeldaIFX = 10;
                $posicion_MulticeldaIFY = $posicion_MulticeldaIFY + 65; //47
                //Imagen a mostrar dentro de cuadro
                $posicion_MulticeldaIIX = 15;
...
while($fila = $resultado6->fetch(PDO::FETCH_ASSOC))
    {
        ...
        $pdf->SetFont('TIMES','B', 14);
        $pdf->SetXY(90, 60);
        $pdf->Cell(65, 5, utf8_decode('Certificaciones'), 0, 'C');
